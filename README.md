...
| `revere_debug_extension` | [![pub package](https://img.shields.io/pub/v/revere_debug_extension.svg)](https://pub.dev/packages/revere_debug_extension) [![pub points](https://img.shields.io/pub/points/revere_debug_extension)](https://pub.dev/packages/revere_debug_extension/score) | Flutter in-app metrics/log viewer and debug UI (real-time metrics collection, log/metrics display widgets, floating debug button, stateful log history). |
