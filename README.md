...
| `flutter_extension` | [![pub package](https://img.shields.io/pub/v/flutter_extension.svg)](https://pub.dev/packages/flutter_extension) [![pub points](https://img.shields.io/pub/points/flutter_extension)](https://pub.dev/packages/flutter_extension/score) | Flutter error tracking and integration (global error hooks, etc.) are provided in this package. |
