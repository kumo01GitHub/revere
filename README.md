...
|---|---|---|---|
| `revere` | <a href="https://pub.dev/packages/revere"><img src="https://img.shields.io/pub/v/revere.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/revere/score"><img src="https://img.shields.io/pub/points/revere" height="20" alt="pub points"></a> | Core logger primitives: `Logger`, `Transport`, `LogEvent`, `LogLevel`, built-in console and HTTP transports |
| `file_transport` | <a href="https://pub.dev/packages/file_transport"><img src="https://img.shields.io/pub/v/file_transport.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/file_transport/score"><img src="https://img.shields.io/pub/points/file_transport" height="20" alt="pub points"></a> | File output and rolling file output |
| `firebase_transport` | <a href="https://pub.dev/packages/firebase_transport"><img src="https://img.shields.io/pub/v/firebase_transport.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/firebase_transport/score"><img src="https://img.shields.io/pub/points/firebase_transport" height="20" alt="pub points"></a> | Firebase Analytics and Crashlytics transports |
| `android_log_transport` | <a href="https://pub.dev/packages/android_log_transport"><img src="https://img.shields.io/pub/v/android_log_transport.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/android_log_transport/score"><img src="https://img.shields.io/pub/points/android_log_transport" height="20" alt="pub points"></a> | Android Logcat transport |
| `notification_transport` | <a href="https://pub.dev/packages/notification_transport"><img src="https://img.shields.io/pub/v/notification_transport.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/notification_transport/score"><img src="https://img.shields.io/pub/points/notification_transport" height="20" alt="pub points"></a> | Local notification transport (mobile/desktop) |
| `swift_log_transport` | <a href="https://pub.dev/packages/swift_log_transport"><img src="https://img.shields.io/pub/v/swift_log_transport.svg" height="20" alt="pub package"></a> | <a href="https://pub.dev/packages/swift_log_transport/score"><img src="https://img.shields.io/pub/points/swift_log_transport" height="20" alt="pub points"></a> | Apple swift-log transport for iOS/macOS |
